...
const HomeScreen = ({ navigation }) => {
  ...
  return (
    ...
    <Box style={{left:26, top:30, marginBottom:40}}>
      ...
      <FormControl  w="85%" h='65px' >
        <FormControl.Label  fontSize={'16'} fontFamily={'Overpass-Black'}>Password</FormControl.Label>
    ...
    I Agree with BellFast’s terms & conditions
      ...
      <Button style={{width:360,height:58, backgroundColor:'#513DB0',borderRadius:12,fontSize:15,lineHeight:21}} onPress={() => navigation.navigate('JoinAs')} >Sign Up</Button>
      </Box>
      <HStack style={{ marginTop:70,marginBottom:20,textAlign:'center',justifyContent:'center',fontSize:14,fontWeight:'500'}}>
   ...
   Login
      ...
      <HStack  space={3} style={{ marginTop:20,marginBottom:20,textAlign:'center',justifyContent:'center',fontSize:14,fontWeight:'500'}}>
      <Divider my="2" color={'#B3B3B3'} />
        <Text style={styles.bottomContainer}> Sign up with  </Text>  
        <Divider my="2" color={'#B3B3B3'} />
          </HStack>
          <HStack style={{ marginTop:0,marginBottom:40,textAlign:'center',justifyContent:'space-between',fontSize:14,fontWeight:'500'}}>
        <TouchableOpacity>
        <Image  source={require('./components/auth/assets/fb.png')}/></TouchableOpacity>
        <TouchableOpacity>
